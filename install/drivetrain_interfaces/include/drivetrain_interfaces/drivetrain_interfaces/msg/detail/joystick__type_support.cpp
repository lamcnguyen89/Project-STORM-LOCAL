...
{
  new (message_memory) drivetrain_interfaces::msg::Joystick(_init);
}

void Joystick_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drivetrain_interfaces::msg::Joystick *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Joystick_message_member_array[2] = {
  {
    ...
    offsetof(drivetrain_interfaces::msg::Joystick, left_joystick_y_axis),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drivetrain_interfaces::msg::Joystick, right_joystick_x_axis),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Joystick_message_members = {
  "drivetrain_interfaces::msg",  // message namespace
  "Joystick",  // message name
  2,  // number of fields
  sizeof(drivetrain_interfaces::msg::Joystick),
...
{
  return &::drivetrain_interfaces::msg::rosidl_typesupport_introspection_cpp::Joystick_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drivetrain_interfaces, msg, Joystick)() {
  return &::drivetrain_interfaces::msg::rosidl_typesupport_introspection_cpp::Joystick_message_type_support_handle;
}
