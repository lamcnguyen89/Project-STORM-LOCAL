...
#include "drivetrain_interfaces/msg/detail/joystick__rosidl_typesupport_fastrtps_c.h"
...
#include "drivetrain_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Joystick__ros_msg_type = drivetrain_interfaces__msg__Joystick;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: left_joystick_y_axis
  {
    cdr << ros_message->left_joystick_y_axis;
  }

  // Field name: right_joystick_x_axis
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drivetrain_interfaces
size_t get_serialized_size_drivetrain_interfaces__msg__Joystick(
  const void * untyped_ros_message,
...
static uint32_t _Joystick__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drivetrain_interfaces__msg__Joystick(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drivetrain_interfaces
size_t max_serialized_size_drivetrain_interfaces__msg__Joystick(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drivetrain_interfaces__msg__Joystick;
    is_plain =
      (
...
static size_t _Joystick__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drivetrain_interfaces__msg__Joystick(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drivetrain_interfaces, msg, Joystick)() {
